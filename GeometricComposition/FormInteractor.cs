...
namespace GeometricComposition
{
    ...
    {
        private MainForm gcForm = null;

        public GCFile CurrentFile { get { return gcForm.SelectedFile; } }
        public GCContentManager ContentManager { get { return gcForm.ContentManager; } }

        public FormInteractor(MainForm gcf)
        {
            gcForm = gcf;
        }
        ...
        {
            gcForm.SelectedFile.DisplayForm.ExtraPoints = new Vector3[] { p1.Position, p2.Position, p3.Position, p4.Position };
        }
        public void DisplayExtraPointsPitch(GCPitch p1, GCPitch p2, GCPitch p3, GCPitch p4)
        {
            gcForm.SelectedFile.DisplayForm.ExtraPointsPitch = new GCPitch[] { p1, p2, p3, p4 };
        }

        public void UseModifiders(int[] mi)
        {
            //gcForm.SelectedFile.DF;
        }
    }
}
