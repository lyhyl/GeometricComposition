...
{
    public interface IDockContent : IDockConentFloatSetting
    {
    ...
    public interface IDockConentFloatSetting
    {
        FormBorderStyle FloatWindowBorderStyle { get; }
        Size FloatWindowDefalutSize { get; }
    }
